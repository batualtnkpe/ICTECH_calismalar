...
HD_PWD='E:/BATUHAN DOSYALAR/ICTECH/devler/devlerim/my_xor_gate/my_xor_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_xor_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_xor_gate.tcl
