...
HD_PWD='E:/BATUHAN DOSYALAR/ICTECH/devler/devlerim/ripple_carry_adder_4-bit/ripple_carry_adder_4-bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_carry_adder_4_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_carry_adder_4_bit.tcl
